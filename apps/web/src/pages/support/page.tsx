...
export default function SupportPage() {
  ...
  return (
    <MainLayout classNames="flex flex-col flex-grow container mx-auto max-w-4xl">
      <div className="p-6 md:p-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          Support & Contact
        </h1>

        <p className="text-subtle text-center mb-12">
          Need help or want to give feedback? Reach out to us through any of the
          following channels. We’re here to make your experience with IdeeLab

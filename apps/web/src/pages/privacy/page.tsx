      ...
      <main className="min-h-screen flex flex-col flex-grow container mx-auto py-20 max-w-7xl">
        <div className="p-6 md:p-8">
          ...
          <p className="text-subtle mb-6">
            ...
            explore and engage with creative programming ideas.
          </p>
          ...
          <div className="space-y-6">
            <div className="pb-4">
              ...
              <ul className="list-disc list-inside text-subtle space-y-2 ml-2">
                ...
                <li>
                  <strong>Account Data:</strong> To suggest new ideas or
                  interact (via comments or votes), we collect your email and
                  basic login credentials.
                </li>
                <li>
                  <strong>User Interactions:</strong> When you vote on an idea
                  or post a comment, this information is stored as part of your
                  account activity.
                </li>
                <li>
            ...
            <div className="pb-4">
              ...
              <p className="text-subtle mb-2">
                ...
                platform (via basic analytics). You can control or disable
            ...
            <div className="pb-4">
              ...
              <ul className="list-disc list-inside text-subtle space-y-2 ml-2">
                ...
                <li>
                  ...
                  as hosting services, analytics tools, or email systems) only
                  as necessary to operate the platform. These providers are
            ...
            <div className="pb-4">
              ...
              <ul className="list-disc list-inside text-subtle space-y-2 ml-2">
                ...
                <li>
                  You can request correction or deletion of your account and
                  data.
                </li>
            ...
            <div className="pb-4">
              ...
              <p className="text-subtle">
                ...
                will be posted here along with the updated &quot;Last
                updated&quot; date. If significant changes are made, we will
                notify users via email or platform announcements.
              </p>
            </div>
          </div>

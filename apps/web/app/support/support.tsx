        ...
        <div className="flex flex-col gap-4 mb-30">
          <div className="flex items-center justify-between bg-outline/5 border border-outline/30 rounded-xl px-8 py-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-subtle">
                Get direct help via email — we usually respond within 24 hours.
              </p>
            </div>
            <a
              target="_blank"
              ...
              className="hover:text-subtle font-medium flex items-center"
            >
          ...
          <div className="flex items-center justify-between bg-outline/5 border border-outline/30 rounded-xl px-8 py-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-subtle">
                Spotted a bug or have a suggestion? Submit an issue on GitHub.
              </p>
            </div>
            <a
              target="_blank"
          ...
          <div className="flex items-center justify-between bg-outline/5 border border-outline/30 rounded-xl px-8 py-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-subtle">
                Ask questions, share feedback, and connect with the community.
              </p>
            </div>
            <a
              target="_blank"
